...
# states : labels
states_label1 = {"s1":[], "s2":[], "s3":[], "s4":[], "s5":[],
                 "s6":[], "s7":["obs"], "s8":["obs"], "s9":[], "s10":[],
                 "s11":[], "s12":[], "s13":[], "s14":[], "s15":[],
                 "s16":[], "s17":[], "s18":[], "s19":[], "s20":[],
                 "s21":[], "s22":[], "s23":[], "s24":["dest"], "s25":[]}

states_label2 = {"s1":[], "s2":[], "s3":["obs"], "s4":[], "s5":[],
                 "s6":[], "s7":[], "s8":[], "s9":["mid"], "s10":["obs"],
                 "s11":["mid"], "s12":["mid"], "s13":[], "s14":["obs"], "s15":["mid"],
                 "s16":[], "s17":[], "s18":[], "s19":["mid"], "s20":["obs"],
                 "s21":[], "s22":[], "s23":[], "s24":["dest"], "s25":[]}
...
states_label4 = {"s1":[], "s2":[], "s3":[], "s4":[], "s5":[],
                 "s6":["mid"], "s7":["obs"], "s8":["obs"], "s9":["mid", "peak"], "s10":["obs"],
                 "s11":[], "s12":[], "s13":[], "s14":[], "s15":[],
                 "s16":["obs"], "s17":["obs"], "s18":["mid"], "s19":["obs"], "s20":[],
                 "s21":[], "s22":[], "s23":[], "s24":["dest"], "s25":[]}
...
'''a very simple environment for verification'''
states_features_tr = {"s0":[0.4, 0.8], "s1":[0.2, 0.8], "s2":[0.6, 0.6]}
states_actions_tr = {"s0":["a1", "a3"], "s1":["a1", "a2"], "s2":["a1", "a2", "a3"]}
trans_rew_tr = {("s0", "a1"):["s1", 1.0, 2.0], ("s0", "a3"):["s2", 1.0, 2.0],
                ("s1", "a1"):["s2", 1.0, 8.0], ("s1", "a2"):["s0", 1.0, 1.0],
                ("s2", "a1"):["s2", 1.0, 1.0], ("s2", "a2"):["s1", 1.0, 1.0], ("s2", "a3"):["s0", 1.0, 2.0]}
states_label1_tr = {"s0":["green"], "s1":["dest", "red"], "s2":["obs", "red"]}
