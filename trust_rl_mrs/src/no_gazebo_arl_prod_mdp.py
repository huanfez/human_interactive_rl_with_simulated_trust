...
from env_abstraction import envAbstract as envabs, setting_environment as env, setup_learning_env4 as setlearn
...
if __name__ == '__main__':
    try:
        ...
        for iteration in range(1, iterations):
            ...
            sampled_beta2_4 = np.random.choice(beta2_4_list, min(len(policy_dict), sample_size), replace=False, p=beta2_4_prob_list)
            ...
            samples = pmc3.iterated_sampling(y_1toK, Z_1toK, setlearn.Beta0_itr, setlearn.Sigma0_itr,
                                             setlearn.a0_itr, setlearn.b0_itr, setlearn.c0_itr, setlearn.d0_itr,
                                             setlearn.Alpha, iters=7000)
