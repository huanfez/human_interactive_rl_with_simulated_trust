...
def sample_beta2_4(interested_vals, posterior_mean, posterior_var, iteration_num):
    ...
    beta2_4_prob_list = [posterior_distribution.pdf(np.array(beta2_4_val)) for beta2_4_val in interested_vals]
    beta2_4_prob_list = [np.exp(np.log(prob) - np.log(np.sum(beta2_4_prob_list))) for prob in beta2_4_prob_list]
...
if __name__ == '__main__':
    try:
        ...
        for iteration in range(1, episodes):
            ...
            sampled_beta2_4 = sample_beta2_4(interested_betas, prior_beta2_4_mean, prior_beta2_4_var, iteration)
